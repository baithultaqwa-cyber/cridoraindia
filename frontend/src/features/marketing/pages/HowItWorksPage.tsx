...
const steps = [
  ...
  {
    title: 'Track',
    body: 'Your holdings stay visible with simple history and live-market context — no trading terminal.',
  },
  {
    title: 'Redeem',
    body: 'Pick participating stores and products — jewellery, coins, or bars where offered.',
  },
  {
    title: 'Transfer',
    body: 'Share gold with family for weddings and gifts where product rules allow.',
  },
  {
    title: 'Grow',
    body: 'Layer schemes, vaults, and partner offers over time — always with jewellers in the story.',
  },
]
